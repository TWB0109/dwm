...
static const char *fonts[]          = { 
    ...
    "Product Sans:pixelsize=13:weight=bold:antialias=true",
};
...
static const Rule rules[] = {
	...
	{ "Gnome-calculator",  NULL,    NULL,    1 << 8,   1,           -1 },
    { NULL,                NULL,    "nmtui", 1 << 8,   1,           -1 },
};
...
static const char *dmenu[] = { "dmenu_run", "-p", "RUN:", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_d,      spawn,          {.v = rofi } },
